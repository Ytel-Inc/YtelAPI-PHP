 ...
 */
class DedicatedShortCodeController extends BaseController
{
    /**
     * @var DedicatedShortCodeController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return DedicatedShortCodeController The *Singleton* instance.
     */
