 ...
 */
class Body77 implements JsonSerializable
{
    /**
     ...
     * @required
     * @maps GroupConfirmKey
     * @var string $groupConfirmKey public property
     */
    public $groupConfirmKey;

    /**
     * Specify the audio file you want to play when the called party picks up the call
     * @required
     * @maps GroupConfirmFile
     * @var string $groupConfirmFile public property
     */
    public $groupConfirmFile;
     ...
     * @maps HideCallerId
     * @var string|null $hideCallerId public property
     */
    public $hideCallerId;
     ...
     * @param string  $groupConfirmKey       Initialization value for $this->groupConfirmKey
     * @param string  $groupConfirmFile      Initialization value for $this->groupConfirmFile
     ...
     * @param string  $hideCallerId          Initialization value for $this->hideCallerId
    ...
    public function __construct()
    {
        if (20 == func_num_args()) {
            ...
            $this->groupConfirmKey       = func_get_arg(3);
            $this->groupConfirmFile      = func_get_arg(4);
            $this->method                = func_get_arg(5);
            $this->statusCallBackUrl     = func_get_arg(6);
            $this->statusCallBackMethod  = func_get_arg(7);
            $this->fallBackUrl           = func_get_arg(8);
            $this->fallBackMethod        = func_get_arg(9);
            $this->heartBeatUrl          = func_get_arg(10);
            $this->heartBeatMethod       = func_get_arg(11);
            $this->timeout               = func_get_arg(12);
            $this->playDtmf              = func_get_arg(13);
            $this->hideCallerId          = func_get_arg(14);
            $this->record                = func_get_arg(15);
            $this->recordCallBackUrl     = func_get_arg(16);
            $this->recordCallBackMethod  = func_get_arg(17);
            $this->transcribe            = func_get_arg(18);
            $this->transcribeCallBackUrl = func_get_arg(19);
        }
    }
    ...
    public function jsonSerialize()
    {
        ...
        $json['To']                    = $this->to;
        $json['Url']                   = $this->url;
        $json['GroupConfirmKey']       = $this->groupConfirmKey;
        $json['GroupConfirmFile']      = $this->groupConfirmFile;
