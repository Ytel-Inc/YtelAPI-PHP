...
use YtelAPILib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var YtelAPILib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var YtelAPILib\Http\HttpResponse
     */
    private $response;
     ...
     * @return YtelAPILib\Http\HttpRequest
     */
     ...
     * @return YtelAPILib\Http\HttpResponse
     */
